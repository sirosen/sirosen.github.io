/*!
  Highlight.js v11.2.0 (git: 817563417f)
...
const f="[a-zA-Z]\\w*",E="[a-zA-Z_]\\w*",N="\\b\\d+(\\.\\d+)?",y="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",w="\\b(0b[01]+)",v={
...
},S=x("//","$"),A=x("/\\*","\\*/"),k=x("#","$");var C=Object.freeze({
...
},COMMENT:x,C_LINE_COMMENT_MODE:S,C_BLOCK_COMMENT_MODE:A,HASH_COMMENT_MODE:k,
...
return n?Number(n):(e=>z.includes(e.toLowerCase()))(e)?0:1}const j={},P=e=>{
...
i=e,a=n),void 0===t&&(t=!0);const s={code:a,language:i};y("before:highlight",s)
;const r=s.result?s.result:b(s.language,s.code,t)
;return r.code=s.code,y("after:highlight",r),r}function b(e,t,i,s){
const l=Object.create(null);function c(){if(!M.keywords)return void S.addText(A)
...
const[e,a]=s
;if(S.addText(t),t="",l[i]=(l[i]||0)+1,l[i]<=7&&(k+=a),e.startsWith("_"))t+=n[0];else{
const t=w.classNameAliases[e]||e;S.addKeyword(n[0],t)}}else t+=n[0]
;e=M.keywordPatternRe.lastIndex,n=M.keywordPatternRe.exec(A)}var a
;t+=A.substr(e),S.addText(t)}function g(){null!=M.subLanguage?(()=>{
if(""===A)return;let e=null;if("string"==typeof M.subLanguage){
if(!n[M.subLanguage])return void S.addText(A)
;e=b(M.subLanguage,A,!0,x[M.subLanguage]),x[M.subLanguage]=e._top
}else e=m(A,M.subLanguage.length?M.subLanguage:null)
;M.relevance>0&&(k+=e.relevance),S.addSublanguage(e._emitter,e.language)
})():c(),A=""}function u(e,n){let t=1;for(;void 0!==n[t];){if(!e._emit[t]){t++
;continue}const a=w.classNameAliases[e[t]]||e[t],i=n[t]
;a?S.addKeyword(i,a):(A=i,c(),A=""),t++}}function p(e,n){
return e.scope&&"string"==typeof e.scope&&S.openNode(w.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(S.addKeyword(A,w.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
...
return 0===M.matcher.regexIndex?(A+=e[0],1):(R=!0,0)}function E(e){
...
u(M.endScope,e)):s.skip?A+=n:(s.returnEnd||s.excludeEnd||(A+=n),
g(),s.excludeEnd&&(A=n));do{
M.scope&&S.closeNode(),M.skip||M.subLanguage||(k+=M.relevance),M=M.parent
}while(M!==i.parent);return i.starts&&p(i.starts,e),s.returnEnd?0:n.length}
let N={};function y(n,s){const o=s&&s[0];if(A+=n,null==o)return g(),0
;if("begin"===N.type&&"end"===s.type&&N.index===s.index&&""===o){
if(A+=t.slice(s.index,s.index+1),!r){const n=Error(`0 width match regex (${e})`)
...
g(),t.returnBegin||t.excludeBegin||(A=n)),p(t,e),t.returnBegin?0:n.length})(s)
;if("illegal"===s.type&&!i){
...
;return A+=o,o.length}const w=f(e)
...
;e.forEach((e=>S.openNode(e)))})();let A="",k=0,C=0,T=0,R=!1;try{
for(M.matcher.considerAll();;){
T++,R?R=!1:M.matcher.considerAll(),M.matcher.lastIndex=C
;const e=M.matcher.exec(t);if(!e)break;const n=y(t.substring(C,e.index),e)
;C=e.index+n}return y(t.substr(C)),S.closeAllNodes(),S.finalize(),O=S.toHTML(),{
language:e,value:O,relevance:k,illegal:!1,_emitter:S,_top:M}}catch(n){
...
;return n._emitter.addText(e),n})(e),i=t.filter(f).filter(N).map((n=>b(n,e,!1)))
...
}),y("after:highlightElement",{el:e,result:s,text:a})}let _=!1;function h(){
...
i[e.toLowerCase()]=n}))}function N(e){const n=f(e)
...
_:[...me,...pe]}},N={variants:[{match:[/function/,/\s+/,n,/(?=\s*\()/]},{
match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},
label:"func.def",contains:[h],illegal:/%/},y={
...
begin:t.begin,end:t.end,skip:!0,contains:["self"]}]}]},N,{
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,m(...ye,...we)],
className:{2:"keyword"}},s={match:b(/\./,m(...Oe)),relevance:0
},r=Oe.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Oe.filter((e=>"string"!=typeof e)).concat(ve).map(Ne),...we)}]},l={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(Se),literal:Me},c=[i,s,o],d=[{
match:b(/\./,m(...Ae)),relevance:0},{className:"built_in",
match:b(/\b/,m(...Ae),/(?=\()/)}],u={match:/->/,relevance:0},p=[u,{
...
match:b(/\\/,e,/[\t ]*(?:[\r\n]|\r\n)/)}),N=(e="")=>({className:"subst",
label:"interpol",begin:b(/\\/,e,/\(/),end:/\)/}),y=(e="")=>({begin:b(e,/"""/),
end:b(/"""/,e),contains:[f(e),E(e),N(e)]}),w=(e="")=>({begin:b(e,/"/),
end:b(/"/,e),contains:[f(e),N(e)]}),v={className:"string",
variants:[y(),y("#"),y("##"),y("###"),w(),w("#"),w("##"),w("###")]},O={
...
match:/\.\.\./,relevance:0},{match:b(/\s+&\s+/,g(Be)),relevance:0}]},A={
begin:/</,end:/>/,keywords:l,contains:[...a,...c,...x,u,S]};S.contains.push(A)
...
},...a,...c,...p,h,v,...x,S,k],endsParent:!0,illegal:/["']/},R={
...
},...c,...d,...p,h,v,...M,...x,S,k]}},grmr_typescript:e=>{const n={$pattern:ge,
...
aliases:["yml"],contains:l}},grmr_awk:e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})});const Fe=Y
;for(const e of Object.keys(ze)){const n=e.replace("grmr_","").replace("_","-")
;Fe.registerLanguage(n,ze[e])}return Fe}()
